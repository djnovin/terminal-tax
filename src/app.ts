...
const TAX_BRACKETS: Record<string, readonly TaxBracket[]> = {
  "2022-2023": [
    ...
    { min: 18_201, max: 45_000, rate: 0.19, base: 0 },
    { min: 45_001, max: 120_000, rate: 0.325, base: 5_092 },
    { min: 120_001, max: 180_000, rate: 0.37, base: 29_467 },
    { min: 180_001, max: Number.POSITIVE_INFINITY, rate: 0.45, base: 51_667 },
  ],
  "2023-2024": [
    { min: 0, max: 18_200, rate: 0, base: 0 },
    { min: 18_201, max: 45_000, rate: 0.19, base: 0 },
    { min: 45_001, max: 120_001, rate: 0.325, base: 5_092 },
    { min: 120_001, max: 180_000, rate: 0.37, base: 29_467 },
    { min: 180_001, max: Number.POSITIVE_INFINITY, rate: 0.45, base: 51_667 },
  ],
  "2024-2025": [
    ...
    { min: 45_001, max: 135_000, rate: 0.3, base: 4_288 },
    { min: 135_001, max: 190_000, rate: 0.37, base: 31_288 },
    { min: 190_001, max: Number.POSITIVE_INFINITY, rate: 0.45, base: 51_638 },
  ],
  "2025-2026": [
    { min: 0, max: 18_200, rate: 0, base: 0 },
